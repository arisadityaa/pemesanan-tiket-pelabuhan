                    ...
                    <div class="row">
                        <div class="col">
                            <div class="form-group">
                                ...
                                <input type="text" value="{{$ticket->stock}}" class="form-control" id="stock" disabled>
                            </div>
                        </div>
                        <div class="col">
                            <div class="form-group">
                                <label for="price" class="col-form-label">Price</label>
                                <input type="text" value="{{$ticket->price}}" class="form-control" id="price" disabled>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="form-group">
                                ...
                                <input type="text" value="{{$ticket->location->name}}" class="form-control" id="location" disabled>
                            </div>
                        </div>
                        <div class="col">
                            <div class="form-group">
                                <label for="sail-time" class="col-form-label">Sail Time</label>
                                <input type="text" value="{{date('D, d M Y h:i', strtotime($ticket->sail_time))}}" class="form-control" id="sail-time" disabled>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="card-body">
                        <form action="/ticket/boking" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" value="{{$ticket->name}}" class="form-control" id="recipient-name" disabled>
                            </div>
                            <div class="form-group">
                                <label for="total-price" class="col-form-label d-flex justify-content-center">Harga</label>
                                <input type="number" id="total-price" value="{{$ticket->price}}" name="total_price" class="form-control" readonly>
                            </div>
